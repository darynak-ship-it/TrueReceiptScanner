...
#ifndef RECEIPT_SCANNER_SWIFT_H
#define RECEIPT_SCANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Receipt_Scanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSDate;
@class NSURL;
@interface Receipt (SWIFT_EXTENSION(Receipt_Scanner))
...
@property (nonatomic, copy) NSString * _Nullable categoryEmoji;
@property (nonatomic, copy) NSString * _Nullable paymentMethod;
@property (nonatomic, copy) NSString * _Nullable paymentEmoji;
@property (nonatomic) BOOL isTaxDeductible;
...
@property (nonatomic, copy) NSString * _Nullable recognizedText;
@property (nonatomic, copy) NSDate * _Nullable createdAt;
@property (nonatomic, copy) NSDate * _Nullable updatedAt;
@property (nonatomic) BOOL isManualEntry;
@property (nonatomic, copy) NSString * _Nullable compressionType;
@property (nonatomic) int64_t originalFileSize;
...
@interface Report (SWIFT_EXTENSION(Receipt_Scanner))
@property (nonatomic, copy) NSUUID * _Nullable id;
...
@property (nonatomic) int32_t receiptCount;
@end
